...
| Distribution | The very first re-send | The staging table creates itself, shaped from TM_EXTEND_LEADS. No script needed unless the role lacks CREATE TABLE, and then the error says which step failed and why | |
